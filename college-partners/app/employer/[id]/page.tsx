    ...
    <main className="mx-auto py-17.5 pl-25 pr-12.5">
      ...
      <section id="main" className="flex justify-between gap-7 mb-37">
        <div className="w-1/2 flex flex-col">
          <h1
            className={`text-5xl font-semibold px-5 py-2.5 rounded-[1.875rem] w-fit ${employer.badgeColor}`}
          >
            {employer.name}
          </h1>
          ...
          <button className="w-full h-fit rounded-[3.75rem] flex justify-between py-5 px-13.75 bg-[#272727] items-center mt-auto">
            ...
            <svg
              className="w-[9.625rem] h-[3.75rem]"
              width="154"
              height="60"
              viewBox="0 0 154 60"
              fill="none"
            ...
            >
              ...
              />
              <path
                d="M137.316 14.8598C138.439 14.8598 139.349 13.858 139.349 12.6223C139.349 11.3865 138.439 10.3848 137.316 10.3848C136.192 10.3848 135.281 11.3865 135.281 12.6223C135.281 13.858 136.192 14.8598 137.316 14.8598Z"
                fill="#272727"
              />
            </svg>
          </button>
      ...
      <section id="aboutUs" className="mb-30.5 flex flex-col gap-11.5">
        <h2
          className={`font-semibold text-8xl ${employer.vacanciesInfoColor} w-fit`}
        >
          Вакансии
        </h2>
        ...
        <div className="flex gap-8.5 w-fit h-fit">
          <div className="relative bg-[#EBF2FA] rounded-[2.1875rem] w-[52.4375rem] h-[40rem]">
            <h2 className="font-semibold text-[4rem] text-[#272727] w-[26.75rem] ml-9.5 mt-6.75">
              {employer.vacanciesInfo}
            </h2>
            <Image
          ...
          <div className="grid grid-cols-2 grid-rows-2 gap-5.75">
            {employer.vacancies.map((item) => {
              // Если у объекта есть свойство Img, возвращаем этот HTML код
              if (item.Img) {
                return (
                  <div
                    key={item.id}
                    className="relative col-span-1 row-span-2 rounded-[2.1875rem] overflow-hidden w-[27.125rem] h-[19.625rem]"
                  >
                    <Image
                      src={item.Img}
                      alt="Приходи к нам"
              ...
              // Иначе возвращаем этот HTML код
              return (
                <div
                  key={item.id}
                ...
                >
                  {/* Цифра (id) */}
                  <span className="text-8xl font-semiboldbold text-[#272727]">
                    {item.id}
                  </span>
      ...
      <section className="flex flex-col items-center gap-14.5">
        <h1 className="font-semibold text-8xl text-center text-[#262729]">
          Ценности и миссия
        </h1>
        <div className="w-fit h-fit flex gap-4.75">
          <div className="w-[54.5625rem] h-[19.75rem] rounded-[2.5rem] py-6.75 px-6.25 bg-[#EAEAEA] flex flex-col gap-8">
            ...
            <p className="font-medium text-[2.3125rem] text-[#262729]">
              {employer.values}
            </p>
          </div>
          <div className="w-[54.5625rem] h-[19.75rem] rounded-[2.5rem] py-6.75 px-6.25 bg-[#EAEAEA] flex flex-col gap-8">
